...
| 14 | Supplied source and ten-target coordinate files | Setup, raw TSV, grouped summary, persistence table, findings, checksum, and screenshot | Complete supplied package |
