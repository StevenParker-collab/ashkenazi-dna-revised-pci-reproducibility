...
> Steven Parker. *Ashkenazi DNA Under the Microscope: Debunking the Europe-Levant Intermediate Myth.*

The submitted manuscript is preserved as a PDF in `manuscript/`. The repository contains the author-generated qpAdm and FST audit trail retained from the earlier repository and the linked Global25 Experiments 1-15 used in the revised manuscript.

## Repository contents

- `manuscript/`: the revised 33-page PDF.
